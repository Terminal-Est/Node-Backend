...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} locale The language used to select the default base model.
     * @param {Object} opts Optional parameters
     * @param {String} opts.endDate The end date of the audio logs deletion (specific day, UTC).              Expected format: \"yyyy-mm-dd\". for instance, \"2019-09-20\" results in deleting all logs on September 20th, 2019 and before.              Deletes all existing logs when date is not specified.
