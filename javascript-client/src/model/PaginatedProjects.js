...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SpeechToTextApiV30.PaginatedProjects = factory(root.SpeechToTextApiV30.ApiClient, root.SpeechToTextApiV30.Project);
  }
  ...
  /**
   * Constructs a new <code>PaginatedProjects</code>.
   * @alias module:model/PaginatedProjects
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedProjects</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedProjects} obj Optional instance to populate.
   * @return {module:model/PaginatedProjects} The populated <code>PaginatedProjects</code> instance.
   */
