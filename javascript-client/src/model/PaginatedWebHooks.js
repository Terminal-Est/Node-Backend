...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SpeechToTextApiV30.PaginatedWebHooks = factory(root.SpeechToTextApiV30.ApiClient, root.SpeechToTextApiV30.WebHook);
  }
}(this, function(ApiClient, WebHook) {
  'use strict';

  /**
   * The PaginatedWebHooks model module.
   * @module model/PaginatedWebHooks
   * @version v3.0
   */

  /**
   * Constructs a new <code>PaginatedWebHooks</code>.
   * @alias module:model/PaginatedWebHooks
   * @class
   */
  ...
  /**
   * Constructs a <code>PaginatedWebHooks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaginatedWebHooks} obj Optional instance to populate.
   * @return {module:model/PaginatedWebHooks} The populated <code>PaginatedWebHooks</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('values'))
        obj.values = ApiClient.convertToType(data['values'], [WebHook]);
