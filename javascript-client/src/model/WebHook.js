...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/WebHookEvents', 'model/WebHookLinks', 'model/WebHookProperties'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./WebHookEvents'), require('./WebHookLinks'), require('./WebHookProperties'));
  } else {
    // Browser globals (root is window)
    if (!root.SpeechToTextApiV30) {
      root.SpeechToTextApiV30 = {};
    }
    root.SpeechToTextApiV30.WebHook = factory(root.SpeechToTextApiV30.ApiClient, root.SpeechToTextApiV30.WebHookEvents, root.SpeechToTextApiV30.WebHookLinks, root.SpeechToTextApiV30.WebHookProperties);
  }
}(this, function(ApiClient, WebHookEvents, WebHookLinks, WebHookProperties) {
  'use strict';
