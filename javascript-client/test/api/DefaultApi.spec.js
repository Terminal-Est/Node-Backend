    ...
    describe('DefaultApi', function() {
      ...
      describe('createHook', function() {
        it('should call createHook successfully', function(done) {
          ...
          opts.webHook.webUrl = "";
          opts.webHook.events = new SpeechToTextApiV30.WebHookEvents();
          opts.webHook.events.datasetCreation = false;
          opts.webHook.events.datasetProcessing = false;
          opts.webHook.events.datasetCompletion = false;
          opts.webHook.events.datasetDeletion = false;
          opts.webHook.events.modelCreation = false;
          opts.webHook.events.modelProcessing = false;
          opts.webHook.events.modelCompletion = false;
          opts.webHook.events.modelDeletion = false;
          opts.webHook.events.evaluationCreation = false;
          opts.webHook.events.evaluationProcessing = false;
          opts.webHook.events.evaluationCompletion = false;
          opts.webHook.events.evaluationDeletion = false;
          opts.webHook.events.transcriptionCreation = false;
          opts.webHook.events.transcriptionProcessing = false;
          opts.webHook.events.transcriptionCompletion = false;
          opts.webHook.events.transcriptionDeletion = false;
          opts.webHook.events.endpointCreation = false;
          opts.webHook.events.endpointProcessing = false;
          opts.webHook.events.endpointCompletion = false;
          opts.webHook.events.endpointDeletion = false;
          opts.webHook.events.ping = false;
          opts.webHook.events.challenge = false;
          ...
          instance.createHook(opts, function(error, data, response) {
            ...
            expect(data.events).to.be.a(SpeechToTextApiV30.WebHookEvents);
      ...
      describe('updateHook', function() {
        it('should call updateHook successfully', function(done) {
          ...
          opts.webHookUpdate.events = new SpeechToTextApiV30.WebHookEvents1();
          opts.webHookUpdate.events.datasetDeletion = false;
          opts.webHookUpdate.events.datasetCreation = false;
          opts.webHookUpdate.events.datasetProcessing = false;
          opts.webHookUpdate.events.datasetCompletion = false;
          opts.webHookUpdate.events.modelCreation = false;
          opts.webHookUpdate.events.modelProcessing = false;
          opts.webHookUpdate.events.modelCompletion = false;
          opts.webHookUpdate.events.modelDeletion = false;
          opts.webHookUpdate.events.evaluationCreation = false;
          opts.webHookUpdate.events.evaluationProcessing = false;
          opts.webHookUpdate.events.evaluationCompletion = false;
          opts.webHookUpdate.events.evaluationDeletion = false;
          opts.webHookUpdate.events.transcriptionCreation = false;
          opts.webHookUpdate.events.transcriptionProcessing = false;
          opts.webHookUpdate.events.transcriptionCompletion = false;
          opts.webHookUpdate.events.transcriptionDeletion = false;
          opts.webHookUpdate.events.endpointCreation = false;
          opts.webHookUpdate.events.endpointProcessing = false;
          opts.webHookUpdate.events.endpointCompletion = false;
          opts.webHookUpdate.events.endpointDeletion = false;
          opts.webHookUpdate.events.ping = false;
          opts.webHookUpdate.events.challenge = false;
