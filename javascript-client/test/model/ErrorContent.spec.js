...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorContent', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.ErrorContent();
      });

      it('should create an instance of ErrorContent', function() {
        // TODO: update the code to test ErrorContent
        expect(instance).to.be.a(SpeechToTextApiV30.ErrorContent);
      });
