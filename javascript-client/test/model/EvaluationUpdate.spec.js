...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EvaluationUpdate', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.EvaluationUpdate();
      });

      it('should create an instance of EvaluationUpdate', function() {
        // TODO: update the code to test EvaluationUpdate
        expect(instance).to.be.a(SpeechToTextApiV30.EvaluationUpdate);
      });
