...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelUpdate', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.ModelUpdate();
      });

      it('should create an instance of ModelUpdate', function() {
        // TODO: update the code to test ModelUpdate
        expect(instance).to.be.a(SpeechToTextApiV30.ModelUpdate);
      });
