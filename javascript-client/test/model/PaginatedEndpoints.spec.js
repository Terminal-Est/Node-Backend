...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginatedEndpoints', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.PaginatedEndpoints();
      });

      it('should create an instance of PaginatedEndpoints', function() {
        // TODO: update the code to test PaginatedEndpoints
        expect(instance).to.be.a(SpeechToTextApiV30.PaginatedEndpoints);
      });
