...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginatedFiles', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.PaginatedFiles();
      });

      it('should create an instance of PaginatedFiles', function() {
        // TODO: update the code to test PaginatedFiles
        expect(instance).to.be.a(SpeechToTextApiV30.PaginatedFiles);
      });
