...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginatedModels', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.PaginatedModels();
      });

      it('should create an instance of PaginatedModels', function() {
        // TODO: update the code to test PaginatedModels
        expect(instance).to.be.a(SpeechToTextApiV30.PaginatedModels);
      });
