...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginatedTranscriptions', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.PaginatedTranscriptions();
      });

      it('should create an instance of PaginatedTranscriptions', function() {
        // TODO: update the code to test PaginatedTranscriptions
        expect(instance).to.be.a(SpeechToTextApiV30.PaginatedTranscriptions);
      });
