...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaginatedWebHooks', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.PaginatedWebHooks();
      });

      it('should create an instance of PaginatedWebHooks', function() {
        // TODO: update the code to test PaginatedWebHooks
        expect(instance).to.be.a(SpeechToTextApiV30.PaginatedWebHooks);
      });
