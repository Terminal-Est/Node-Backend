...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebHookPropertiesUpdate', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.WebHookPropertiesUpdate();
      });

      it('should create an instance of WebHookPropertiesUpdate', function() {
        // TODO: update the code to test WebHookPropertiesUpdate
        expect(instance).to.be.a(SpeechToTextApiV30.WebHookPropertiesUpdate);
      });
