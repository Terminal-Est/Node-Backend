...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebHookUpdate', function() {
      beforeEach(function() {
        instance = new SpeechToTextApiV30.WebHookUpdate();
      });

      it('should create an instance of WebHookUpdate', function() {
        // TODO: update the code to test WebHookUpdate
        expect(instance).to.be.a(SpeechToTextApiV30.WebHookUpdate);
      });
